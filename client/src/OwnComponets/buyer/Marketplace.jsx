...
export default function MarketplacePage({ tradingRooms }) {
  const navigate = useNavigate();
  const [filterStatus, setFilterStatus] = useState("All");

  // Filter the crops based on status (you might want to adjust this based on your crop logic)
  const filteredCrops = tradingRooms?.filter(
    (crop) =>
              ...
              <div className="space-y-4">
                ...
                <div className="flex justify-between text-sm text-gray-500 dark:text-gray-400">
                  <p>
                    ...
                    <span
                      className={
                        crop.isSold ? "text-red-500" : "text-green-500"
                      }
                    >
